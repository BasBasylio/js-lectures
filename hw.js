...
function desision(gamburger1, fries1, menu1) {
    if ((gamburger1 >= 4 && fries1 >= 1) || (menu1 >= 1 && gamburger1 >= 3)) {
        console.log ('поїли')
    }
    else
    console.log ('йдемо в інше кафе')
...
function priceDesision1(price3) {
...
function timeOfTheYearDesision1(timeOfTheYear1) {
    if (timeOfTheYear1 == 1) {
        console.log('Winter')
    } else if (timeOfTheYear1 == 2) {
        console.log('Spring')
    } else if (timeOfTheYear1 == 3) {
        console.log('Summer')
    } else if (timeOfTheYear1 == 4) {
        console.log('Autumn')
    } else {
        console.log('index isn`t correct')
    }
}
timeOfTheYearDesision1(2)
...
function midleNumber(a1,b1,c1) {
    if (a1 < b1 && a1 > c1) {
        console.log('a = ' + a1 + ' - average value')
    } else if (a1 > b1 && a1 < c1) {
        console.log('a = ' + a1 + ' - average value')
    } else if (a1 > b1 && b1 > c1) {
        console.log('b = ' + b1 + ' - average value')
    } else if (a1 < b1 && b1 < c1) {
        console.log('b = ' + b1 + ' - average value')
    } else if (a1 > c1 && b1 < c1) {
        console.log('c = ' + c1 + ' - average value')
    } else if (a1 < c1 && b1 > c1) {
        console.log('c = ' + c1 + ' - average value')
    } else {
        console.log('no average value identyfing')
...
function DayOfTheWeekIndex(DayOfTheWeek1) {
...
function mathHelp(firstNumber1,secondNumber1,math1) {
    switch (math1) {
        case '+':
...
function strHelp(str1) {
    console.log  (str1 = str1.replace(/[aeiou]/gi, ''));
}
strHelp('EkolobasikU')
...
console.log(metr1 + " метр" + metryToKilometry(metr1) + " = " + kilometr1 + " кілометр" + metryToKilometry(kilometr1))
